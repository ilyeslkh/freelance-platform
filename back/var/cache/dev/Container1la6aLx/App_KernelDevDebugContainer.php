...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\ServiceDetailController' => 'getServiceDetailControllerService',
            'App\\Controller\\ServiceEditController' => 'getServiceEditControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/RedirectBannedSubscriber.php';
            ...
            include_once \dirname(__DIR__, 4).'/src/Services/GlobalCategoriesSubscriber.php';
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1mojBa7gMp', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('d7sIcyrSyq', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.controller', [#[\Closure(name: 'App\\EventSubscriber\\TwigGlobalSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\TwigGlobalSubscriber'] ?? self::getTwigGlobalSubscriberService($container)), 'onKernelController'], 0);
        $instance->addListener('kernel.controller', [#[\Closure(name: 'App\\EventSubscriber\\RedirectBannedSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\RedirectBannedSubscriber'] ?? self::getRedirectBannedSubscriberService($container)), 'onKernelController'], 0);
        $instance->addListener('kernel.controller', [#[\Closure(name: 'App\\Services\\GlobalCategoriesSubscriber')] fn () => ($container->privates['App\\Services\\GlobalCategoriesSubscriber'] ?? self::getGlobalCategoriesSubscriberService($container)), 'onKernelController'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AdminController', 'App\\Controller\\CategoryController', 'App\\Controller\\ClientController', 'App\\Controller\\DashboardController', 'App\\Controller\\FreelancerController', 'App\\Controller\\GoogleController', 'App\\Controller\\HomeController', 'App\\Controller\\JobController', 'App\\Controller\\LoginController', 'App\\Controller\\PaymentController', 'App\\Controller\\ProfileController', 'App\\Controller\\RegistrationController', 'App\\Controller\\ServiceController', 'App\\Controller\\ServiceDetailController', 'App\\Controller\\ServiceEditController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private 'App\EventSubscriber\RedirectBannedSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\RedirectBannedSubscriber
     */
    protected static function getRedirectBannedSubscriberService($container)
    {
        $a = ($container->privates['security.helper'] ?? self::getSecurity_HelperService($container));

        if (isset($container->privates['App\\EventSubscriber\\RedirectBannedSubscriber'])) {
            return $container->privates['App\\EventSubscriber\\RedirectBannedSubscriber'];
        }

        return $container->privates['App\\EventSubscriber\\RedirectBannedSubscriber'] = new \App\EventSubscriber\RedirectBannedSubscriber($a, ($container->services['router'] ?? self::getRouterService($container)));
    }

    /**
     * Gets the private 'App\EventSubscriber\TwigGlobalSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\TwigGlobalSubscriber
     */
    protected static function getTwigGlobalSubscriberService($container)
    {
        $a = ($container->privates['twig'] ?? self::getTwigService($container));

        if (isset($container->privates['App\\EventSubscriber\\TwigGlobalSubscriber'])) {
            return $container->privates['App\\EventSubscriber\\TwigGlobalSubscriber'];
        }

        return $container->privates['App\\EventSubscriber\\TwigGlobalSubscriber'] = new \App\EventSubscriber\TwigGlobalSubscriber(($container->privates['App\\Repository\\CategoryRepository'] ?? self::getCategoryRepositoryService($container)), $a);
    }
    ...
    /**
     * Gets the private 'App\Services\GlobalCategoriesSubscriber' shared autowired service.
     *
     * @return \App\Services\GlobalCategoriesSubscriber
     */
    protected static function getGlobalCategoriesSubscriberService($container)
    {
        $a = ($container->privates['twig'] ?? self::getTwigService($container));

        if (isset($container->privates['App\\Services\\GlobalCategoriesSubscriber'])) {
            return $container->privates['App\\Services\\GlobalCategoriesSubscriber'];
        }

        return $container->privates['App\\Services\\GlobalCategoriesSubscriber'] = new \App\Services\GlobalCategoriesSubscriber(($container->privates['App\\Repository\\CategoryRepository'] ?? self::getCategoryRepositoryService($container)), $a);
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uBiF7C6E+D', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5NgDv-XvDH', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4z3AFUyHYd', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C27YzONjvv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDebug_Security_Access_DecisionManagerService($container)
    {
        return $container->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 3 => ($container->privates['.debug.security.voter.App\\Security\\JobApplicationVoter'] ?? $container->load('getJobApplicationVoterService'));
    ...
    protected static function getSecurity_HelperService($container)
    {
        return $container->privates['security.helper'] = new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'debug.App\\Security\\GoogleAuthenticator' => ['privates', 'debug.App\\Security\\GoogleAuthenticator', 'getGoogleAuthenticatorService', true],
            ...
            'debug.App\\Security\\GoogleAuthenticator' => '?',
    ...
    protected static function getSerializerService($container)
    {
        ...
        $t = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($m, $r, $b, $c, $s, NULL, [], $c);
